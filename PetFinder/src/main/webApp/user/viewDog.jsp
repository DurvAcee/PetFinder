        ...
        <div class="col-md-6 col-md-offset-1 col-sm-12 col-xs-12" style="padding-top: 45px; padding-left: 110px;">
            ...
            <div class="certified">
                <ul>
		            ...
		            <li>
		                <a href="javascript:void(0);"> Status <span> ${dog.dogstatus} </span></a>
		            </li><br/>
                </ul>
            </div>
            <hr />
            ...
            <div class="row">
                ...
                <button type="button" onclick="myFunction3()" class="btn btn-success btn-lg">Adopt!</button>
...
<form id="myForm" method="post" action="adoptedDog">
		<input type="hidden" value="${dog.dogid}" name="dogid">
   	    <input type="hidden" value="${dog.dogname}" name="dogname">
   	     ...
   	     <input type="hidden" value="${dog.dogfile}" name="dogfile">
...
function myFunction3() {
	...
	if(true) {
		Swal.fire({
			  icon: "info",
			  title: 'Are you sure?',
			  text: "Once Your Application is submitted, we will review it and give you a call regarding the Adoption process",
			  showDenyButton: true,
			  ...
			  if (result.isConfirmed) {
			    ...
			    Swal.fire('Your Application has been withdrawn!', '', 'warning')
			  }
			})
	}
}
